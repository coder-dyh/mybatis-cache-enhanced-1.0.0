...
import org.mybatis.cache.impl.EnhancedCachingManagerImpl;
...
public class EnhancedCachingExecutor implements Interceptor {
    ...
    /**
     * refresh the session org.mybatis.cache,there are two things have to do:
     * 1. add this session scope query logs to global org.mybatis.cache Manager
